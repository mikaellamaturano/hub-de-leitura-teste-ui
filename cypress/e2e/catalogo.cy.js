...
describe('Funcionalidade: Catálogo de livros', () => {
    ...
    it('Deve clicar no nome do livro e direcionar para a tela do livro', () => {
        ...
        cy.url().should('include', 'book-details') // Verifica se a URL contém o ID do livro
        cy.get('#add-to-cart-btn').click()
        cy.get('#alert-container').should('contain', 'Livro adicionado à cesta com sucesso!') // Verifica se o alerta contém o nome do livro adicionado à cesta
    });
});